  ...
  return (
    <div className="w-full flex flex-col">
      <Suspense fallback={<LoadingSpinner fullScreen size="xl" />}>
        <BannerAbboutUs
          image="/banners/sobrenosotros/banner-1.webp"
          className="bg-black"
        >
          <section className="relative text-center">
            <h2 className="text-5xl sm:text-7xl md:text-7xl text-orange-50 leading-tight tracking-wide drop-shadow-lg">
              Un <span className="font-bold text-[#ec5406]">internet</span> para{" "}
              <br />
          ...
          <div className="w-full">
            ...
            >
              <AccordionItem value="item-1" className="border rounded-lg px-6">
                ...
                <AccordionContent className="flex flex-col gap-4 text-balance pb-6">
                  <p className="text-base lg:text-lg text-secondary-foreground/80 leading-relaxed">
                    ...
                    tecnologías de la información y comunicaciones, contribuirá
                    al logro de la equidad social, al acceso a oportunidades y a
                    la reducción de las brechas digitales del país
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-2" className="border rounded-lg px-6">
                ...
                <AccordionContent className="flex flex-col gap-4 text-balance pb-6">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-base lg:text-lg text-secondary-foreground/80">
                    ...
                    <li>
                      Ser referente como lugar ideal para trabajar en el sur de
                      la ciudad.
                    </li>
                  </ul>
                </AccordionContent>
              ...
              <AccordionItem value="item-3" className="border rounded-lg px-6">
                ...
                <AccordionContent className="flex flex-col gap-4 text-balance pb-6">
                  <p className="text-base lg:text-lg text-secondary-foreground/80 leading-relaxed">
                    Como parte de nuestro compromiso con el desarrollo social y
                    la inclusión digital, hemos implementado un programa de
                    responsabilidad corporativa enfocado en brindar acceso
                    gratuito a internet a comunidades vulnerables. Actualmente,{" "}
                    <span className="font-bold">
                      más de 32 fundaciones y organizaciones sin ánimo de lucro
                    </span>{" "}
                    se benefician de nuestro servicio de conectividad sin costo,
                    permitiéndoles fortalecer sus procesos educativos, sociales
                    y comunitarios. Esta iniciativa busca reducir la brecha
                    tecnológica en poblaciones en situación de vulnerabilidad,
                    facilitando el acceso a herramientas digitales, plataformas
                    educativas y servicios esenciales en línea. Nuestro servicio
                    donado es{" "}
                    <span className="font-bold">
                      100% fibra óptica hasta el hogar (FTTH)
                    </span>
                    , lo que garantiza una conexión de alta velocidad, estable y
                    con baja latencia, adaptada a las necesidades operativas de
                    estas entidades.
                  </p>
                  <p className="text-base lg:text-lg text-secondary-foreground/80 leading-relaxed">
              ...
              <AccordionItem value="item-4" className="border rounded-lg px-6">
                ...
                <AccordionContent className="flex flex-col gap-4 text-balance pb-6">
                  <p className="text-base lg:text-lg text-secondary-foreground/80 leading-relaxed">
                    ...
                    de nuestros usuarios. Por eso hemos implementado un programa
                    de incentivos exclusivos, diseñado para reconocer a quienes
                    mantienen sus obligaciones al día y eligen canales digitales
                    eficientes. Nuestros clientes que realizan el pago
                    anticipado de su servicio o que utilizan medios electrónicos
                    como PSE (Pago Seguro en Línea), acceden automáticamente a
                    un sistema de recompensas que incluye:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-base lg:text-lg text-secondary-foreground/80">
                    <li>
